...
> **Welcome to Product-Track Week 2, Task 3!**
...
| `src/permissionEngine.ts` | Main source code - **has bugs to fix** |
| `src/roleDefinitions.ts` | Supporting code - **may also have bugs** |
| `tests/test_permissionEngine.test.ts` | Test file - **add your tests here** |
